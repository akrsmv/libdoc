...
import { __createItem, generateDataModel } from '@incta/ddb-model'; // in case you want generate models from the test, see option 1) below
...
beforeAll(() => {
    ...
    */
    // // option 1)
    // first regenerated model:
    // const dataModelFilesOutDir = resolve('packages/ddb-model/src/__testdata__/generated-definition')
    // const dataModelsDir = resolve('packages/ddb-model/src/__testdata__/domain-context')
    // generateDataModel({ generateHollowImplFiles: false, dataModelFilesOutDir, dataModelsDir, importLibraryToUseInGeneratedFiles: '../../../interfaces/DdbItem' })
